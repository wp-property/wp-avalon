(function ($) {
  ...
  wp.customize('frontpage_aboutus_title_setting', function (value) {
    value.bind(function (newval) {
      if (newval == '') {
        $('.frontpage-about-us-area .faua__title').css('display', 'none');
      } else {
        $('.frontpage-about-us-area .faua__title').css('display', 'block');
      }
      $('.frontpage-about-us-area .faua__title').html(newval);
    });
  });
  ...
  wp.customize('focus_section_title_setting', function (value) {
    value.bind(function (newval) {
      if (newval == '') {
        $('.frontpage-focus-widget-area .ffwa__title').css('display', 'none');
      } else {
        $('.frontpage-focus-widget-area .ffwa__title').css('display', 'block');
      }
  ...
  wp.customize('property_overview_title', function (value) {
    value.bind(function (newval) {
      if (newval == '') {
        $('.frontpage-overview-widget-area .fowa__title').css('display', 'none');
      } else {
        $('.frontpage-overview-widget-area .fowa__title').css('display', 'block');
      }
  ...
  wp.customize('about_products_title_setting', function (value) {
    value.bind(function (newval) {
      if (newval == '') {
        $('.frontpage-about-products-area .faua__title').css('display', 'none');
      } else {
        $('.frontpage-about-products-area .faua__title').css('display', 'block');
      }
      $('.frontpage-about-products-area .faua__title').html(newval);
    });
  });
  ...
  wp.customize('flip_section_title', function (value) {
    value.bind(function (newval) {
      if (newval == '') {
        $('.frontpage-flip-widget-area .ffwa__title').css('display', 'none');
      } else {
        $('.frontpage-flip-widget-area .ffwa__title').css('display', 'block');
      }
  ...
  wp.customize('avalon_propertyoverview_bg_color', function (value) {
    value.bind(function (newval) {
  ...
  wp.customize('avalon_propertyoverview_text_color', function (value) {
    value.bind(function (newval) {
      $('.property.avalon_property .property_div_box .wpp_overview_right_column .property_bottom .pb__left').css('color', newval);
      $('.property.avalon_property .property_div_box .wpp_overview_right_column .property_bottom .pb__right .property_price').css('color', newval);
      $('.wpp_property_overview_shortcode .wpp_grid_view.wpp_property_view_result .all-properties .property .property_div_box .wpp_overview_left_column .property_type_label').css('color', newval);
      $('.wpp_property_overview_shortcode .wpp_grid_view.wpp_property_view_result .all-properties .property .property_div_box .property_featured_label span').css('color', newval);
      $('.wpp_property_overview_shortcode .wpp_grid_view.wpp_property_view_result .all-properties .property .property_div_box .wpp_overview_right_column .property_bottom .pb__right .property_price').css('color', newval);
      $('.wpp_property_overview_shortcode .wpp_grid_view.wpp_property_view_result .all-properties .property .property_div_box .wpp_overview_right_column .property_bottom .pb__left').css('color', newval);
    });
  });
