...
$section_title = get_theme_mod('property_overview_title', __('WP-Property overview of listings', 'wp-avalon'));
if ($enable_section != 1) :
  ?>
  <div class="frontpage-overview-widget-area" data-template="template-parts/front-page/frontpage-overview-widget-area">
      <div class="row">
        <div class="col-md-12">
          <div class="fowa__title" style="display: <?php echo $section_title ? 'block' : 'none'; ?>">
