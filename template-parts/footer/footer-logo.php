...
<a href="<?php echo site_url(); ?>" title="<?php echo get_bloginfo('name'); ?>">
    ...
    $icon_url = get_theme_mod('avalon_footer_logo_icon_settings');
    $logo_text = get_theme_mod('avalon_footer_logo_text_settings');
    $margin_icon = get_theme_mod('avalon_footer_logo_icon_margin_setting');
    $margin = get_theme_mod('avalon_footer_logo_img_margin_setting');
    if (!empty($logo_image)) :
